...
const users: User[] = [
  { id: 1, full_name: "John", email: "john@test.com", role: "Administrator", status: 0, admin: true },
  { id: 2, full_name: "Jane", email: "jane@test.com", role: "Administrator", status: 1, admin: false },
  { id: 3, full_name: "Peter", email: "peter@test.com", role: "System User", status: 1, admin: true },
  { id: 4, full_name: "Sarah", email: "sarah@test.com", role: "System User", status: 1, admin: true },
  { id: 5, full_name: "David", email: "david@test.com", role: "System User", status: 0, admin: false },
];
